/**
 * ---------------------------------------------------------------------------------------------------------------------
 * \file	transfer_interrupt.cpp
 * General Data Transfer Rate Test
 * This example demonstrates basic data transfer functionality with the updated library. This example will display the
 * transfer rates acheived using the slower form of high-speed transfer using blocking-writes.
 *
 * ---------------------------------------------------------------------------------------------------------------------
 * \date	2014-2017
 ...
 * See http://www.airspayce.com/mikem/bcm2835/group__constants.html#ga63c029bd6500167152db4e57736d0939 and the related
 * enumerations for pin information.
 */
...
/**
 * Raspberry Pi Alternative Configuration
 * \note	Specify the SPI bus number (0 or 1) instead of the CS pin number.
 ...
 * \note	Edit RF24/arch/BBB/spi.cpp and set 'this->device = "/dev/spidev0.0";;' or as listed in /dev */
//RF24 radio(22, 0);


/* ---( Linux (BeagleBone Black, x86, etc.) )--- */
...
/* Setup for ARM (Linux) devices like the BeagleBone Black using spidev (default is "/dev/spidev1.0") */
//RF24 radio(115, 0);

/**
 * BeagleBone Black Alternate, with MRAA
